      ...
      >
        ...
        <div className="relative flex items-center gap-5">
          <div className="relative shrink-0">
            <div className="size-24 md:size-32 rounded-2xl overflow-hidden">
              <img src={s3} alt="" loading="lazy" className="size-full object-cover" />
            </div>
            <div className="absolute -bottom-2 -right-2 size-9 rounded-full bg-gradient-gold flex items-center justify-center">
              <Sparkles className="size-4 text-primary-foreground" />
            </div>
          </div>
          <div className="flex-1">
            <p className="text-xs uppercase tracking-[0.2em] text-gold/80">New</p>
            <h3 className="font-display text-2xl md:text-3xl mt-1">Try it on, virtually.</h3>
            <p className="text-xs md:text-sm text-muted-foreground mt-2">
              See any style on you before booking — gentle, private, magical.
            </p>
            <button className="mt-3 inline-flex items-center gap-1.5 text-xs font-medium text-gold">
